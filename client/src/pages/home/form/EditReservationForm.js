...
const EditReservationForm = ({ id }) => {
    ...
    // const handleSubmit = useSubmit(name, url, partySize, time, startDate, endDate, id);
    ...
    return (
        <div className={styles.form} data-testid="form">
            ...
            <form
                ...
                <input type="submit" value="Submit" className={styles.submit} onClick={handleSubmit} />
            </form>
        </div>
    );
};
